...
namespace ImageMozaic.Data
{
    public class ProcessImage
    {
        ...
        private List<Imageinformation> library;
        ...
        public Imageinformation GetAverageColor(Bitmap bmp, string filePath)
        {
            var imageInfo = new Imageinformation(filePath);
        ...
        public Mosaic Render(Bitmap img, Color[,] colorMap, List<Imageinformation> imageInfos)
        {
